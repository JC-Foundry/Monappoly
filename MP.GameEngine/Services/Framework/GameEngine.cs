...
public sealed class GameEngine(GameCacheModel cache, ISnapshotService snapshotService)
{
    public GameCacheModel Cache { get; } = cache;
    public IPromptProvider PromptProvider { get; } = new PromptProvider(cache);
