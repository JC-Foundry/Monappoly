...
{
    /// <inheritdoc />
    public partial class RenamedCustomBoards : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardSkins", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");

            migrationBuilder.CreateTable(
                name: "BoardSkinSpaces",
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(38)", maxLength: 38, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardSkinSpaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardSkinSpaces_BoardSkins_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardSkinSpaces_BoardId",
