...
(function () {
    ...
    function onOpen(prompt, stamp, hubCtx) {
        // Render only for the player this profile page belongs to (the host answers
        // on a player's behalf server-side; the page is still that player's profile,
        // so the playerId check holds for both).
